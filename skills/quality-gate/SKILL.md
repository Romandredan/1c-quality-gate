...
Слова, которые плагин употребляет как свои — контур, профиль изменения, архетип, признак,
эвристика, часовой, след прогона, — объяснены в `references/glossary.md`. Незнакомое слово
смотреть там, а не выводить из контекста.
