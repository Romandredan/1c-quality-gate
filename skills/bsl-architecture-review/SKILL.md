...
description: >-
  ...
  связанность модулей, ветвление вместо единого метода-диспетчера, дублирование, переусложнение.
...
разрешения; при эвристическом — понижай важность находки на ступень и формулируй её как вопрос,
а не как утверждение.

**2. Полнотекстовый поиск доказывает наличие, но не отсутствие.** Он ограничен числом
просматриваемых файлов. Область поиска — явный список изменённых файлов; пустой результат даёт
...
- **Уверенность заявляется.** Эвристическое разрешение ссылок понижает важность находки и меняет
