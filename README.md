...
| [tests/](tests/run-tests.mjs) | самодостаточный раннер; фикстуры с байтовой семантикой генерируются, а не хранятся; [`tests/recall/`](tests/recall.mjs) — контрольные примеры и замер полноты читателя каталога, результаты в `.gitignore` |
