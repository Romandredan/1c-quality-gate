...
|---|---|---|
| `code` | диагностики статического анализатора, сверка кода со справочником платформы (члены типов, системные перечисления, конструкторы — по настройке), антипаттерны производительности и механики платформы, стандарты разработки `#stdNNN`, именование, сверка сигнатур API и существования общих модулей; лексические проверки текстов запросов и транзакций в обработчиках событий | с класса `C1` |
