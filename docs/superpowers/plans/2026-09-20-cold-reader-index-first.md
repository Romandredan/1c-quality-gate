...
**Spec:** обсуждение 2026-09-20. Замер расхода по транскриптам боевого проекта: около ста ходов основной модели на прогон при контексте сессии ~460k токенов, субагенты — около 6 % стоимости прогона. Связанное предложение 10 в `docs/superpowers/specs/2026-09-12-improvement-ideas.md`.
