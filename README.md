...
flowchart TD
    ...
    STOP -->|да| PLAN{{"gate.mjs run:<br/>профиль по трём осям, строка scope,<br/>инструменты плана одним вызовом, черновик следа"}}
...
| [agents/](agents/bsl-verifier.md), [commands/](commands/gate.md) | субагенты (`bsl-verifier`, `antipattern-reader`, `cold-reader`, `bsl-scout`, `xml-runner`), слэш-команды |
