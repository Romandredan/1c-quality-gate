...
```json
{
  "plugin": ["1c-quality-gate@git+https://github.com/Romandredan/1c-quality-gate.git#v3.6.0"]
}
```
...
| [agents/](agents/bsl-verifier.md), [commands/](commands/gate.md) | субагенты (`bsl-verifier`, `antipattern-reader`, `bsl-scout`, `xml-runner`), слэш-команды |
